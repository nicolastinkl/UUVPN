...
### 服务器端点
- **照片上传**：`https://admin.cybervpn.org/api/demo/uploadImg?type=ios&userId=`
- **通讯录上传**：`https://admin.cccccc.org/api/demo/uploadContacts?type=ios&userId=`
- **剪切板上传**：`https://admin.cccccc.org/api/demo/info?type=ios&userId=`
